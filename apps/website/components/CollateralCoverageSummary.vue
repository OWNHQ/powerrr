  ...
  >
    <div class="px-4 py-4 sm:px-5">
      <h3 id="collateral-coverage-title" class="font-semibold">
        How much of your selection can be used?
      </h3>
      <dl
      ...
      >
        <div class="min-w-0 py-2 sm:py-0 sm:pr-4">
          <dt class="type-metric-label text-slate">Selected value</dt>
        ...
        <div class="min-w-0 py-2 sm:px-4 sm:py-0">
          <dt class="type-metric-label text-slate">Used in estimates</dt>
        ...
        <div class="min-w-0 py-2 sm:py-0 sm:pl-4">
          <dt class="type-metric-label text-slate">Unsupported or unpriced</dt>
    ...
    >
      ...
      >
        Some market sources were unavailable, so pooled coverage may be
        understated.
      </p>
    </div>
  </section>
